...
function Home() {
    ...
    return <div>
        <PageTitle title={`
            Hello ${user.firstName} ${user.lastName}, Welcome to ALORB-WALLET    
        `}/>
        <div className='flex flex-col gap-1 bg-tertiary p-2 mt-2 w-50 br-3 upper-case'>
        ...
        <div className='flex flex-col gap-1 card p-2 mt-2 w-50 br-3 upper-case'>
            <div className='flex justify-between'>
